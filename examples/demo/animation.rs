...
pub fn setup(
    ...
    let test_pos = Position::with_xy(window.x_center() as i32 - test_box.x_center() as i32, window.y_center() as i32 - test_box.y_center() as i32);
    ...
    commands.insert_resource(Timer::new(std::time::Duration::from_millis(10), true));
}

#[allow(clippy::too_many_arguments)]
pub fn update(
    keys: ResMut<Events<KeyEvent>>,
